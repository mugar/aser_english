...
/*
 * The model name used for the user role (typically 'Fonction' or 'Fonction')
 */
Configure :: write('acl.aro.role.model', 'Fonction');
...
/*
 * The model name used for the user (typically 'Personnel')
 */
Configure :: write('acl.aro.user.model', 'Personnel');
...
/*
 * The users table field used as identifiant in the views
 * It may be a table field or a SQL expression such as "CONCAT(Personnel.lastname, ' ', Personnel.firstname)" for MySQL or "Personnel.lastname||' '||Personnel.firstname" for PostgreSQL
 */
Configure :: write('acl.user.display_name', "identifiant");
