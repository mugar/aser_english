...
<?php 
	...
	if(!empty($advanced)){
	echo $this->Form->input('Produit.groupe_id',array('id'=>$n°.'GroupeId','label'=>'','selected'=>0,'title'=>'Le sous groupe auquel apchecked_outnt le produit'));
    echo $ajax->observeField($n°.'GroupeId', array('url' => 'sous_groupe/'.$advanced,'update' => 'sous_groupe'.$n°,
		...
		echo $this->Form->input('Produit.groupe_id',array('id'=>$n°.'GroupeId','selected'=>0,'title'=>'Le sous groupe auquel apchecked_outnt le produit'));
