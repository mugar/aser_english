...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(sprintf(__('Modifier %s', true), __('Location', true)), array('action' => 'edit', $location['Location']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Effacer %s', true), __('Location', true)), array('action' => 'delete', $location['Location']['id']), null, sprintf(__('Voulez vous vraiment effacer l\'enregistrement N° %s ?', true), $location['Location']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Lister %s', true), __('Locations', true)), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Créer %s', true), __('Location', true)), array('action' => 'add')); ?> </li>
