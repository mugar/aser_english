...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(sprintf(__('Delete %s', true), __('Config', true)), array('action' => 'delete', $config['Config']['id']), null, sprintf(__('Voulez vous vraiment effacer l\'enregistrement N° %s ?', true), $config['Config']['id'])); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Show %s', true), __('Configs', true)), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(sprintf(__('Create %s', true), __('Config', true)), array('action' => 'add')); ?> </li>
