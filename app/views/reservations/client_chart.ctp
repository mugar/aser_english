...
$graph = new PieGraph(1300,550,"auto");
$graph->SetShadow();
...
$graph->title->Set("Repartition des Reservations par Customer $periode");
...
$p1->SetCenter(400,250);
$p1->title->SetMargin(45);
$p1->SetSliceColors(array('red','pink','yellow','green','purple','blue','brown','black','orange')); 
$graph->Add($p1);
